...
public class StaticImagePoseAnalyzer {
    ...
    public void analyzeImage(Uri imageUri) {
        try {
            ...
            poseDetector.process(image)
                    .addOnSuccessListener(new OnSuccessListener<Pose>() {
                        ...
                        public void onSuccess(Pose pose) {
                            if (pose.getAllPoseLandmarks().isEmpty()) {
                                Log.e("StaticImagePoseAnalyzer",
                                        "No pose landmarks detected in the image.");
                                Toast.makeText(context, "Image unclear, " +
                                        "please use another photo.", Toast.LENGTH_LONG).show();
                                return;
                            }
                            switch (poseName) {
                                case "Bridge":
                    ...
                    .addOnFailureListener(new OnFailureListener() {
                        ...
                        public void onFailure(Exception e) {
                            ...
                            Toast.makeText(context, "Failed to analyze image. Please try again."
            ...
            Toast.makeText(context, "Failed to load image. Please check the image path " +
    ...
    private void checkWarriorPose(Pose pose) {
                ...
                if (leftShoulder == null || rightShoulder == null || leftHip == null
                        || rightHip == null ||
                        leftKnee == null || rightKnee == null || leftAnkle == null
                        || rightAnkle == null) {
                    return;
                }
        ...
        feedbackMap.put("Check1", new Object[]{isFrontKneeBentCorrectly, isFrontKneeBentCorrectly ?
                "Front Knee was at correct angle" : "Front Knee was not at correct angle"});
        feedbackMap.put("Check2", new Object[]{isBackLegStraight, isBackLegStraight ?
                "Back leg was straight" : "Back leg was not straight"});
        feedbackMap.put("Check3", new Object[]{isArmsCorrectlyPositioned, isArmsCorrectlyPositioned ?
                "Arms were straight" : "Arms were not straight"});
        feedbackMap.put("Check4", new Object[]{isBodyCorrectlyPositioned, isBodyCorrectlyPositioned ?
                "Torso was in correct position" : "Torso was not upright"});
        onFinishAnalysis();
    }
    private void checkPelvicCurlPose(Pose pose) {
        ...
        poseChecks.putBoolean("Outcome", isPoseCorrect);
                feedbackMap.put("Check1", new Object[]{isBodyStraight, isBodyStraight ?
                        "Body was Straight" : "Your body was not straight"});
                feedbackMap.put("Check2", new Object[]{isLegBent, isLegBent ?
                        "Leg was in Correct position" : "Your hips were not inline with knees"});
        onFinishAnalysis();
    }
    ...
    protected void checkStandingStraightArmsOutPose(Pose pose) {
        ...
        poseChecks.putBoolean("Outcome", isPoseCorrect);
                feedbackMap.put("Check1", new Object[]{isBodyStraight, isBodyStraight ?
                        "Body was Straight" : "Your body was not straight"});
                feedbackMap.put("Check2", new Object[]{areArmsOut, areArmsOut ?
                        "Arms were perpendicular to body" : "Your arms were not perpendicular to body"});
        onFinishAnalysis();
    }
    private void checkBoatPose(Pose pose) {
        ...
        poseChecks.putBoolean("Outcome", isPoseCorrect);
                feedbackMap.put("Check1", new Object[]{isHipsAngleCorrect, isHipsAngleCorrect ?
                        "Legs were lifted high enough" : "Legs were not lifted high enough"});
                feedbackMap.put("Check2", new Object[]{isLegsStraight, isLegsStraight ?
                        "Legs were straight" : "Legs were not straight"});
                feedbackMap.put("Check3", new Object[]{isArmsParallelToGround,
                        isArmsParallelToGround ? "Arms were parallel to ground" :
                                "Arms were not parallel to ground"});
        onFinishAnalysis();
    }
